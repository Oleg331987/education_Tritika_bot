...
💰 <b>Стоимость:</b> 
   <s>7500 руб.</s> 
   <b>3999 руб.</b> (акция до конца января 2026 года)
...
✨ <b>ОСОБАЯ ЦЕНА ПО АКЦИИ:</b>

<s>Обычная стоимость: 7 500 руб.</s>

🎁 <b>АКЦИОННАЯ ЦЕНА: 3 999 руб.</b>

⏰ <b>Акция действует до конца января 2026 года!</b>

После окончания акции цена курса составит 4 999 руб.

---

<b>📋 ЧТО ВХОДИТ В КУРС:</b>

✅ <b>6 модулей с аудио-сопровождением:</b>
...
📄 <a href="https://tritika.ru/privacy">Политика конфиденциальности tritika.ru</a>
...
2. <b>Перевод по реквизитам</b> (после нажатия кнопки)
...
"""
    ...
    if notification_sent:
        await message.answer(
            ...
            "1. Произведите оплату по QR-коду или реквизитам\n"
...
• Готовый чек-лист в формате Word
...
3. Оплатите курс по акции 3 999 руб.
...
async def run_bot_with_retries():
    ...
    while not shutdown_flag and restart_count < max_restarts:
        try:
            ...
            logger.info(f"✅ Стоимость курса по акции: 3 999 руб. (акция до 01.2026)")
            logger.info(f"✅ Стоимость после акции: 4 999 руб.")
            logger.info(f"✅ Обычная цена: 7 500 руб.")
...
if __name__ == "__main__":
    try:
        ...
        print(f"💰 Стоимость курса по акции: 3 999 руб. (акция до 01.2026)")
        print(f"💰 Стоимость после акции: 4 999 руб.")
        print(f"💰 Обычная цена: 7 500 руб.")
        ...
        print("• QR-код для оплаты 3 999 руб. (акция до 01.2026)")
        print("• После акции цена будет 4 999 руб.")
