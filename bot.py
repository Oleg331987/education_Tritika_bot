...
"""
    ...
    # Убрали вызов send_final_summary, чтобы не показывался День 8 автоматически после теста
...
• {len(MODULES)} модулей с аудио1-сопровождением
