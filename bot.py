...
💰 <b>Стоимость:</b> 
   <s>5 000 руб.</s> 
   <b>3 999 руб. по акции до конца января 2026 года</b>
...
if __name__ == "__main__":
    try:
        ...
        print(f"💰 Стоимость курса: 3 999 руб. (акция до конца января 2026 г.)")
        print(f"💰 После акции: 5 000 руб.")
